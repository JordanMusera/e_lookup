                ...
                {servicesArray.map((service, index) => (
                    <div key={index} className='bg-white border border-gray-300 rounded-xl shadow p-3'>
                        ...
                        <div className='flex justify-between mt-3'>
                            <button className='bg-gray-400 rounded-md p-1 px-2 text-sm'>Edit</button>
                            <button className='bg-gray-400 rounded-md p-1 px-2 text-sm'>Preview</button>
                            <button className='bg-gray-400 rounded-md p-1 px-2 text-sm'>Delete</button>
                        </div>
                    </div>
                ))}
            </div>
